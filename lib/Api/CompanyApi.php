...
class CompanyApi
{
     ...
     */
    public function getCompany($company_id, $select = null)
    {
        list($response) = $this->getCompanyWithHttpInfo($company_id, $select);
        return $response;
    }
     ...
     */
    public function getCompanyWithHttpInfo($company_id, $select = null)
    {
        $request = $this->getCompanyRequest($company_id, $select);
     ...
     */
    public function getCompanyAsync($company_id, $select = null)
    {
        return $this->getCompanyAsyncWithHttpInfo($company_id, $select)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCompanyAsyncWithHttpInfo($company_id, $select = null)
    {
        $returnType = '\OpenAPI\Client\Model\Company';
        $request = $this->getCompanyRequest($company_id, $select);
     ...
     */
    public function getCompanyRequest($company_id, $select = null)
    {
     ...
     */
    public function listCompanies($top = null, $skip = null, $limit = null, $filter = null, $select = null)
    {
        list($response) = $this->listCompaniesWithHttpInfo($top, $skip, $limit, $filter, $select);
        return $response;
    }
     ...
     */
    public function listCompaniesWithHttpInfo($top = null, $skip = null, $limit = null, $filter = null, $select = null)
    {
        $request = $this->listCompaniesRequest($top, $skip, $limit, $filter, $select);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCompaniesAsync($top = null, $skip = null, $limit = null, $filter = null, $select = null)
    {
        return $this->listCompaniesAsyncWithHttpInfo($top, $skip, $limit, $filter, $select)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCompaniesAsyncWithHttpInfo($top = null, $skip = null, $limit = null, $filter = null, $select = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse200';
        $request = $this->listCompaniesRequest($top, $skip, $limit, $filter, $select);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listCompaniesRequest($top = null, $skip = null, $limit = null, $filter = null, $select = null)
    {
