...
class PaymentMethodApi
{
     ...
     * @param  string $payment_method_id (v1.0) id for paymentMethod (required)
     *
    ...
    public function deletePaymentMethodRequest($company_id, $payment_method_id)
    {
        ...
        $resourcePath = '/companies({company_id})/paymentMethods({paymentMethod_id})';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getPaymentMethod($company_id, $payment_method_id, $select = null)
    {
        list($response) = $this->getPaymentMethodWithHttpInfo($company_id, $payment_method_id, $select);
        return $response;
    }
     ...
     */
    public function getPaymentMethodWithHttpInfo($company_id, $payment_method_id, $select = null)
    {
        $request = $this->getPaymentMethodRequest($company_id, $payment_method_id, $select);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentMethodAsync($company_id, $payment_method_id, $select = null)
    {
        return $this->getPaymentMethodAsyncWithHttpInfo($company_id, $payment_method_id, $select)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentMethodAsyncWithHttpInfo($company_id, $payment_method_id, $select = null)
    {
        $returnType = '\OpenAPI\Client\Model\PaymentMethod';
        $request = $this->getPaymentMethodRequest($company_id, $payment_method_id, $select);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPaymentMethodRequest($company_id, $payment_method_id, $select = null)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function listPaymentMethods($company_id, $top = null, $skip = null, $limit = null, $filter = null, $select = null)
    {
        list($response) = $this->listPaymentMethodsWithHttpInfo($company_id, $top, $skip, $limit, $filter, $select);
        return $response;
    }
     ...
     */
    public function listPaymentMethodsWithHttpInfo($company_id, $top = null, $skip = null, $limit = null, $filter = null, $select = null)
    {
        $request = $this->listPaymentMethodsRequest($company_id, $top, $skip, $limit, $filter, $select);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listPaymentMethodsAsync($company_id, $top = null, $skip = null, $limit = null, $filter = null, $select = null)
    {
        return $this->listPaymentMethodsAsyncWithHttpInfo($company_id, $top, $skip, $limit, $filter, $select)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listPaymentMethodsAsyncWithHttpInfo($company_id, $top = null, $skip = null, $limit = null, $filter = null, $select = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20022';
        $request = $this->listPaymentMethodsRequest($company_id, $top, $skip, $limit, $filter, $select);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listPaymentMethodsRequest($company_id, $top = null, $skip = null, $limit = null, $filter = null, $select = null)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/companies({company_id})/paymentMethods';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \OpenAPI\Client\Model\PaymentMethod
     */
    public function patchPaymentMethod($company_id, $payment_method_id, $content_type, $if_match, $unknown_base_type)
    {
        list($response) = $this->patchPaymentMethodWithHttpInfo($company_id, $payment_method_id, $content_type, $if_match, $unknown_base_type);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\PaymentMethod, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchPaymentMethodWithHttpInfo($company_id, $payment_method_id, $content_type, $if_match, $unknown_base_type)
    {
        $request = $this->patchPaymentMethodRequest($company_id, $payment_method_id, $content_type, $if_match, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchPaymentMethodAsync($company_id, $payment_method_id, $content_type, $if_match, $unknown_base_type)
    {
        return $this->patchPaymentMethodAsyncWithHttpInfo($company_id, $payment_method_id, $content_type, $if_match, $unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchPaymentMethodAsyncWithHttpInfo($company_id, $payment_method_id, $content_type, $if_match, $unknown_base_type)
    {
        $returnType = '\OpenAPI\Client\Model\PaymentMethod';
        $request = $this->patchPaymentMethodRequest($company_id, $payment_method_id, $content_type, $if_match, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchPaymentMethodRequest($company_id, $payment_method_id, $content_type, $if_match, $unknown_base_type)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_id when calling patchPaymentMethod'
            );
        }
        // verify the required parameter 'payment_method_id' is set
        if ($payment_method_id === null || (is_array($payment_method_id) && count($payment_method_id) === 0)) {
        ...
        if ($content_type === null || (is_array($content_type) && count($content_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $content_type when calling patchPaymentMethod'
            );
        }
        // verify the required parameter 'if_match' is set
        if ($if_match === null || (is_array($if_match) && count($if_match) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $if_match when calling patchPaymentMethod'
            );
        }
        // verify the required parameter 'unknown_base_type' is set
        if ($unknown_base_type === null || (is_array($unknown_base_type) && count($unknown_base_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unknown_base_type when calling patchPaymentMethod'
            );
        }
     ...
     * @return \OpenAPI\Client\Model\PaymentMethod
     */
    public function postPaymentMethod($company_id, $content_type, $unknown_base_type)
    {
        list($response) = $this->postPaymentMethodWithHttpInfo($company_id, $content_type, $unknown_base_type);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\PaymentMethod, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPaymentMethodWithHttpInfo($company_id, $content_type, $unknown_base_type)
    {
        $request = $this->postPaymentMethodRequest($company_id, $content_type, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPaymentMethodAsync($company_id, $content_type, $unknown_base_type)
    {
        return $this->postPaymentMethodAsyncWithHttpInfo($company_id, $content_type, $unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPaymentMethodAsyncWithHttpInfo($company_id, $content_type, $unknown_base_type)
    {
        $returnType = '\OpenAPI\Client\Model\PaymentMethod';
        $request = $this->postPaymentMethodRequest($company_id, $content_type, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentMethodRequest($company_id, $content_type, $unknown_base_type)
    {
        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_id when calling postPaymentMethod'
            );
        }
        // verify the required parameter 'content_type' is set
        if ($content_type === null || (is_array($content_type) && count($content_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $content_type when calling postPaymentMethod'
            );
        }
        // verify the required parameter 'unknown_base_type' is set
        if ($unknown_base_type === null || (is_array($unknown_base_type) && count($unknown_base_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unknown_base_type when calling postPaymentMethod'
            );
        }
