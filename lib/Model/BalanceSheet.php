...
class BalanceSheet implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets line_number
     *
     * @param int|null $line_number (v1.0) The lineNumber property for the Dynamics 365 Business Central balanceSheet entity
     *
     * @return self
     */
     ...
     * Sets display
     *
     * @param string|null $display (v1.0) The display property for the Dynamics 365 Business Central balanceSheet entity
     *
     * @return self
     */
    public function setDisplay($display)
    {
        if (!is_null($display) && (mb_strlen($display) > 250)) {
            throw new \InvalidArgumentException('invalid length for $display when calling BalanceSheet., must be smaller than or equal to 250.');
        }
     ...
     * Sets balance
     *
     * @param float|null $balance (v1.0) The balance property for the Dynamics 365 Business Central balanceSheet entity
     *
     * @return self
     */
     ...
     * Sets line_type
     *
     * @param string|null $line_type (v1.0) The lineType property for the Dynamics 365 Business Central balanceSheet entity
     *
     * @return self
     */
    public function setLineType($line_type)
    {
        if (!is_null($line_type) && (mb_strlen($line_type) > 30)) {
            throw new \InvalidArgumentException('invalid length for $line_type when calling BalanceSheet., must be smaller than or equal to 30.');
        }
     ...
     * Sets indentation
     *
     * @param int|null $indentation (v1.0) The indentation property for the Dynamics 365 Business Central balanceSheet entity
     *
     * @return self
     */
     ...
     * Sets date_filter
     *
     * @param \DateTime|null $date_filter (v1.0) The dateFilter property for the Dynamics 365 Business Central balanceSheet entity
     *
     * @return self
     */
