...
class BankAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param string|null $id (v1.0) The id property for the Dynamics 365 Business Central bankAccount entity
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param string|null $number (v1.0) The number property for the Dynamics 365 Business Central bankAccount entity
     *
     * @return self
     */
    public function setNumber($number)
    {
        if (!is_null($number) && (mb_strlen($number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $number when calling BankAccount., must be smaller than or equal to 20.');
        }
     ...
     * Sets display_name
     *
     * @param string|null $display_name (v1.0) The displayName property for the Dynamics 365 Business Central bankAccount entity
     *
     * @return self
     */
    public function setDisplayName($display_name)
    {
        if (!is_null($display_name) && (mb_strlen($display_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling BankAccount., must be smaller than or equal to 100.');
        }
