 ...
 */
class PurchaseInvoiceLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'purchaseInvoiceLine';
    ...
    protected static $openAPIFormats = [
        ...
        'expected_receipt_date' => 'date-time',
        'item' => null,
        'account' => null
    ];
    ...
    protected static $setters = [
        ...
        'expected_receipt_date' => 'setExpectedReceiptDate',
        'item' => 'setItem',
        'account' => 'setAccount'
    ];
    ...
    protected static $getters = [
        ...
        'expected_receipt_date' => 'getExpectedReceiptDate',
        'item' => 'getItem',
        'account' => 'getAccount'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['expected_receipt_date'] = $data['expected_receipt_date'] ?? null;
     ...
     * Sets id
     *
     * @param string|null $id (v1.0) The id property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
    public function setId($id)
    {
        if (!is_null($id) && (mb_strlen($id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PurchaseInvoiceLine., must be smaller than or equal to 50.');
        }
     ...
     * Sets document_id
     *
     * @param string|null $document_id (v1.0) The documentId property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     * Sets sequence
     *
     * @param int|null $sequence (v1.0) The sequence property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string|null $item_id (v1.0) The itemId property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     * Sets account_id
     *
     * @param string|null $account_id (v1.0) The accountId property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     * Sets line_type
     *
     * @param string|null $line_type (v1.0) The lineType property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description (v1.0) The description property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 100)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PurchaseInvoiceLine., must be smaller than or equal to 100.');
        }
     ...
     * Sets unit_cost
     *
     * @param float|null $unit_cost (v1.0) The unitCost property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float|null $quantity (v1.0) The quantity property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     *
     * @param float|null $discount_amount (v1.0) The discountAmount property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     *
     * @param float|null $discount_percent (v1.0) The discountPercent property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     *
     * @param bool|null $discount_applied_before_tax (v1.0) The discountAppliedBeforeTax property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     *
     * @param float|null $amount_excluding_tax (v1.0) The amountExcludingTax property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     * Sets tax_code
     *
     * @param string|null $tax_code (v1.0) The taxCode property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
    public function setTaxCode($tax_code)
    {
        if (!is_null($tax_code) && (mb_strlen($tax_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $tax_code when calling PurchaseInvoiceLine., must be smaller than or equal to 50.');
        }
     ...
     * Sets tax_percent
     *
     * @param float|null $tax_percent (v1.0) The taxPercent property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     *
     * @param float|null $total_tax_amount (v1.0) The totalTaxAmount property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     *
     * @param float|null $amount_including_tax (v1.0) The amountIncludingTax property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     *
     * @param float|null $invoice_discount_allocation (v1.0) The invoiceDiscountAllocation property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     * Sets net_amount
     *
     * @param float|null $net_amount (v1.0) The netAmount property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     * Sets net_tax_amount
     *
     * @param float|null $net_tax_amount (v1.0) The netTaxAmount property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
     ...
     *
     * @param float|null $net_amount_including_tax (v1.0) The netAmountIncludingTax property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
    ...
    /**
     * Gets expected_receipt_date
     *
     * @return \DateTime|null
     */
    public function getExpectedReceiptDate()
    {
        return $this->container['expected_receipt_date'];
    }

    /**
     * Sets expected_receipt_date
     *
     * @param \DateTime|null $expected_receipt_date (v1.0) The expectedReceiptDate property for the Dynamics 365 Business Central purchaseInvoiceLine entity
     *
     * @return self
     */
    public function setExpectedReceiptDate($expected_receipt_date)
    {
        $this->container['expected_receipt_date'] = $expected_receipt_date;
