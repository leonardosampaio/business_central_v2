...
class Vendor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['irs1099_code'] = $data['irs1099_code'] ?? null;
     ...
     * Sets id
     *
     * @param string|null $id (v1.0) The id property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param string|null $number (v1.0) The number property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
    public function setNumber($number)
    {
        if (!is_null($number) && (mb_strlen($number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $number when calling Vendor., must be smaller than or equal to 20.');
        }
     ...
     * Sets display_name
     *
     * @param string|null $display_name (v1.0) The displayName property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
    public function setDisplayName($display_name)
    {
        if (!is_null($display_name) && (mb_strlen($display_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling Vendor., must be smaller than or equal to 100.');
        }
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number (v1.0) The phoneNumber property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
    public function setPhoneNumber($phone_number)
    {
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling Vendor., must be smaller than or equal to 30.');
        }
     ...
     * Sets email
     *
     * @param string|null $email (v1.0) The email property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 80)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Vendor., must be smaller than or equal to 80.');
        }
     ...
     * Sets website
     *
     * @param string|null $website (v1.0) The website property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
    public function setWebsite($website)
    {
        if (!is_null($website) && (mb_strlen($website) > 80)) {
            throw new \InvalidArgumentException('invalid length for $website when calling Vendor., must be smaller than or equal to 80.');
        }
     ...
     *
     * @param string|null $tax_registration_number (v1.0) The taxRegistrationNumber property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
    public function setTaxRegistrationNumber($tax_registration_number)
    {
        if (!is_null($tax_registration_number) && (mb_strlen($tax_registration_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $tax_registration_number when calling Vendor., must be smaller than or equal to 20.');
        }
     ...
     * Sets currency_id
     *
     * @param string|null $currency_id (v1.0) The currencyId property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
     ...
     * Sets currency_code
     *
     * @param string|null $currency_code (v1.0) The currencyCode property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getIrs1099Code()
    {
        return $this->container['irs1099_code'];
    }

    /**
     * Sets irs1099_code
     *
     * @param string|null $irs1099_code (v1.0) The irs1099Code property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
    public function setIrs1099Code($irs1099_code)
    {
        $this->container['irs1099_code'] = $irs1099_code;
     ...
     *
     * @param string|null $payment_terms_id (v1.0) The paymentTermsId property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_method_id (v1.0) The paymentMethodId property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
     ...
     * Sets tax_liable
     *
     * @param bool|null $tax_liable (v1.0) The taxLiable property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
     ...
     * Sets blocked
     *
     * @param string|null $blocked (v1.0) The blocked property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
     ...
     * Sets balance
     *
     * @param float|null $balance (v1.0) The balance property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $last_modified_date_time (v1.0) The lastModifiedDateTime property for the Dynamics 365 Business Central vendor entity
     *
     * @return self
     */
