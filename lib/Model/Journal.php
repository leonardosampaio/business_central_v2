...
class Journal implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param string|null $id (v1.0) The id property for the Dynamics 365 Business Central journal entity
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code (v1.0) The code property for the Dynamics 365 Business Central journal entity
     *
     * @return self
     */
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Journal., must be smaller than or equal to 10.');
        }
     ...
     * Sets display_name
     *
     * @param string|null $display_name (v1.0) The displayName property for the Dynamics 365 Business Central journal entity
     *
     * @return self
     */
    public function setDisplayName($display_name)
    {
        if (!is_null($display_name) && (mb_strlen($display_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling Journal., must be smaller than or equal to 100.');
        }
     ...
     *
     * @param \DateTime|null $last_modified_date_time (v1.0) The lastModifiedDateTime property for the Dynamics 365 Business Central journal entity
     *
     * @return self
     */
     ...
     *
     * @param string|null $balancing_account_id (v1.0) The balancingAccountId property for the Dynamics 365 Business Central journal entity
     *
     * @return self
     */
     ...
     *
     * @param string|null $balancing_account_number (v1.0) The balancingAccountNumber property for the Dynamics 365 Business Central journal entity
     *
     * @return self
     */
    public function setBalancingAccountNumber($balancing_account_number)
    {
        if (!is_null($balancing_account_number) && (mb_strlen($balancing_account_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $balancing_account_number when calling Journal., must be smaller than or equal to 20.');
        }
