...
```php
getTrialBalance($company_id, $trial_balance_number, $expand, $select): \OpenAPI\Client\Model\TrialBalance
```
...
$trial_balance_number = 'trial_balance_number_example'; // string | (v1.0) number for trialBalance
$expand = array('expand_example'); // string[] | (v1.0) Entities to expand
$select = array('select_example'); // string[] | (v1.0) Selected properties to be retrieved

try {
    $result = $apiInstance->getTrialBalance($company_id, $trial_balance_number, $expand, $select);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TrialBalanceApi->getTrialBalance: ', $e->getMessage(), PHP_EOL;
}
```
 ...
 **trial_balance_number** | **string**| (v1.0) number for trialBalance |
 **expand** | [**string[]**](../Model/string.md)| (v1.0) Entities to expand | [optional]
 **select** | [**string[]**](../Model/string.md)| (v1.0) Selected properties to be retrieved | [optional]

### Return type

[**\OpenAPI\Client\Model\TrialBalance**](../Model/TrialBalance.md)
...
```php
listTrialBalance($company_id, $top, $skip, $limit, $filter, $expand, $select): \OpenAPI\Client\Model\InlineResponse20038
```
...
try {
    $result = $apiInstance->listTrialBalance($company_id, $top, $skip, $limit, $filter, $expand, $select);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TrialBalanceApi->listTrialBalance: ', $e->getMessage(), PHP_EOL;
}
```
