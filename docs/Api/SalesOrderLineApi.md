# OpenAPI\Client\SalesOrderLineApi
...
```php
deleteSalesOrderLine($company_id, $sales_order_line_id)
```
...
$apiInstance = new OpenAPI\Client\Api\SalesOrderLineApi(
...
$sales_order_line_id = 'sales_order_line_id_example'; // string | (v1.0) id for salesOrderLine

try {
    $apiInstance->deleteSalesOrderLine($company_id, $sales_order_line_id);
} catch (Exception $e) {
    echo 'Exception when calling SalesOrderLineApi->deleteSalesOrderLine: ', $e->getMessage(), PHP_EOL;
}
```
 ...
 **sales_order_line_id** | **string**| (v1.0) id for salesOrderLine |
...
```php
deleteSalesOrderLineForSalesOrder($company_id, $sales_order_id, $sales_order_line_id)
```
...
try {
    $apiInstance->deleteSalesOrderLineForSalesOrder($company_id, $sales_order_id, $sales_order_line_id);
} catch (Exception $e) {
    echo 'Exception when calling SalesOrderLineApi->deleteSalesOrderLineForSalesOrder: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getSalesOrderLine($company_id, $sales_order_line_id, $expand, $select): \OpenAPI\Client\Model\SalesOrderLine
```
...
try {
    $result = $apiInstance->getSalesOrderLine($company_id, $sales_order_line_id, $expand, $select);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SalesOrderLineApi->getSalesOrderLine: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\SalesOrderLine**](../Model/SalesOrderLine.md)
...
```php
getSalesOrderLineForSalesOrder($company_id, $sales_order_id, $sales_order_line_id, $expand, $select): \OpenAPI\Client\Model\SalesOrderLine
```
...
try {
    $result = $apiInstance->getSalesOrderLineForSalesOrder($company_id, $sales_order_id, $sales_order_line_id, $expand, $select);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SalesOrderLineApi->getSalesOrderLineForSalesOrder: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
listSalesOrderLines($company_id, $top, $skip, $limit, $filter, $expand, $select): \OpenAPI\Client\Model\InlineResponse20032
```
...
try {
    $result = $apiInstance->listSalesOrderLines($company_id, $top, $skip, $limit, $filter, $expand, $select);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SalesOrderLineApi->listSalesOrderLines: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
listSalesOrderLinesForSalesOrder($company_id, $sales_order_id, $top, $skip, $limit, $filter, $expand, $select): \OpenAPI\Client\Model\InlineResponse20032
```
...
try {
    $result = $apiInstance->listSalesOrderLinesForSalesOrder($company_id, $sales_order_id, $top, $skip, $limit, $filter, $expand, $select);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SalesOrderLineApi->listSalesOrderLinesForSalesOrder: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
patchSalesOrderLine($company_id, $sales_order_line_id, $content_type, $if_match, $unknown_base_type): \OpenAPI\Client\Model\SalesOrderLine
```
...
try {
    $result = $apiInstance->patchSalesOrderLine($company_id, $sales_order_line_id, $content_type, $if_match, $unknown_base_type);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SalesOrderLineApi->patchSalesOrderLine: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
patchSalesOrderLineForSalesOrder($company_id, $sales_order_id, $sales_order_line_id, $content_type, $if_match, $unknown_base_type): \OpenAPI\Client\Model\SalesOrderLine
```
...
try {
    $result = $apiInstance->patchSalesOrderLineForSalesOrder($company_id, $sales_order_id, $sales_order_line_id, $content_type, $if_match, $unknown_base_type);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SalesOrderLineApi->patchSalesOrderLineForSalesOrder: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
postSalesOrderLine($company_id, $content_type, $unknown_base_type): \OpenAPI\Client\Model\SalesOrderLine
```
...
try {
    $result = $apiInstance->postSalesOrderLine($company_id, $content_type, $unknown_base_type);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SalesOrderLineApi->postSalesOrderLine: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
postSalesOrderLineForSalesOrder($company_id, $sales_order_id, $content_type, $unknown_base_type): \OpenAPI\Client\Model\SalesOrderLine
```
...
try {
    $result = $apiInstance->postSalesOrderLineForSalesOrder($company_id, $sales_order_id, $content_type, $unknown_base_type);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SalesOrderLineApi->postSalesOrderLineForSalesOrder: ', $e->getMessage(), PHP_EOL;
}
```
